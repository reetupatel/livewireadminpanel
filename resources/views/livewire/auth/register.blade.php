    ...
    <div class="bg-white p-4 rounded shadow-lg" style="width: 25rem;">
        ...
        <form>
            <div class="form-group mb-4">
                ...
                <input type="text" placeholder="Enter Name" class="form-control" wire:model="name" required>
                @error('name')
            ...
            <div class="form-group mb-4">
                ...
                <input wire:model="email" placeholder="Enter Email" type="email" class="form-control" wire:model="email" required>
                @error('email')
                    <p class="text-sm text-danger mt-1">{{ $message }}</p>
                @enderror
            </div>
            ...
            <div class="form-group mb-4">
                ...
                <input wire:model="password" placeholder="Enter Password"  type="password" class="form-control" wire:model="password" required>
                @error('password')
                    <p class="text-sm text-danger mt-1">{{ $message }}</p>
                @enderror
            </div>
